    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('¿Está seguro de que desea eliminar el producto "${item.nombre}"?'),
            ...
            if (!item.disponible)
              Container(
                ...
                child: const Text(
                  'Nota: Este producto ya fue vendido. Eliminarlo no afectará la venta.',
          ...
          child: Column(
            ...
            children: [
              ...
              if (item.fechaActualizacion != null)
                _buildDetalleRow('Última Actualización', DateFormat('dd/MM/yyyy HH:mm').format(item.fechaActualizacion!)),
              if (!item.disponible) ...[
                const Divider(),
                const Text('Información de Venta:', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red)),
                ...
                if (item.numeroVenta != null)
                  _buildDetalleRow('Número de Venta', item.numeroVenta!),
              ],
            ],
          ),
        ),
