    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        action: SnackBarAction(
          label: 'Deshacer',
          onPressed: () {
            // Implementar deshacer si es necesario
          },
        ),
      ),
    );
        ...
        const SnackBar(
          content: Row(
            children: [
              ...
              SizedBox(width: 10),
              Text('Agregue productos al carrito para procesar la venta'),
            ],
          ),
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text('Método: ${_formatearMetodoPago(_metodoPago)}'),
            const SizedBox(height: 10),
            const Text('¿Qué desea hacer ahora?', style: TextStyle(fontWeight: FontWeight.bold)),
          ],
        ),
        actions: [
          TextButton(
              ...
              onPressed: () {
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    ...
                    content: const Text('¿Está seguro de que desea limpiar todo el carrito?'),
                    actions: [
                      TextButton(
                        onPressed: () => Navigator.pop(context),
